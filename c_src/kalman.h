...
//Python wrappers
double getKalmanSensorNoise(Kalman*);
double getKalmanProcessNoise(Kalman*);
double getKalmanMeasurement(Kalman*);
double getKalmanVariance(Kalman*);
double getKalmanGain(Kalman*);
#endif
